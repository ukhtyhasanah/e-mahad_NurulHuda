...
<a href="index.php?page=14" class="btn btn-info btn-md pull-right"><i class="fa fa-arrow-left"></i> Kembali</a>
        ...
        <div class="card" style="margin-top: 50px">
            ...
            <div class="card-content">
            	...
            	<form action="" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="upload" class="btn btn-info blue pull-right"><i class="fa fa-upload"></i> Upload File</button>
                </form>
