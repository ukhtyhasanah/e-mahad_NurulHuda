...
if (isset($_POST['submit'])) {
	...
	if ($valid == false) {
		...
		if ($exec) {
			$_SESSION['message'] = "Berhasil ubah data Mata Pelajaran";
    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <div class="card-content">
                <a href="index.php?page=19" class="btn btn-success btn-md pull-right"><i class="fa fa-arrow-left"></i> Kembali</a>
