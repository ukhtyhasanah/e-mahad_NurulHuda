...
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <h4><b><?php echo $nama; ?></b>, Anda melakukan pembayaran dengan metode 
			...
			?>
				...
				<ol>
				<li><b>Siswa Lama CICILAN 1 : </b></li>
				<table class="table table-responsive table-hove">
					<thead>
						<tr>
							<th>Jenis Pengeluaran</th>
			...
			<button class="btn btn-success btn-md pull-right" id="cetak"><i class="fa fa-print"></i>&nbsp; Cetak</button>	
